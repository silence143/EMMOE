...
conv_vicuna_homie = Conversation(
    system="""You are a powerful housework assistant, I will give you following information for you to make a decision toward the final task.
...
Model: Choose one most suitable model in the model list [NoMaD, PixNav, octo, RT-1-X]. NoMaD focuses on image and spot navigation, PixNav focuses on object navigation, octo can handle with open and close, RT-1-X is good at picking and putting.
